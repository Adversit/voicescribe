  ...
  return (
    <div className="space-y-5">
      <header className="space-y-1">
        <h1 className="text-[28px] font-semibold text-ink">说话人</h1>
      ...
      <section className="rounded-[22px] border border-[#e4dbc9] bg-[#faf6ef] p-4">
        <div className="flex items-center justify-between gap-3">
          <div>
            <div className="text-base font-semibold text-ink">已注册说话人</div>
            <div className="mt-1 text-sm text-ink/55">注册后，转录结果会尽量附带说话人标签。</div>
          </div>
          <div className="rounded-full border border-[#ddd2c0] bg-white px-4 py-2 text-sm text-ink/70">
            {speakers.length} 个样本
          </div>
        </div>
        ...
        <div className="mt-4 space-y-3">
          {speakers.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-[#ddd2c0] bg-white px-4 py-4 text-sm text-ink/55">
              暂无已注册说话人。
            </div>
          ) : (
            speakers.map((speaker) => (
              <div
                ...
                className="flex items-center justify-between rounded-2xl border border-[#e4dbc9] bg-white px-4 py-4"
              >
                <div>
      ...
      <section className="rounded-[22px] border border-[#e4dbc9] bg-[#faf6ef] p-4">
        <div className="text-base font-semibold text-ink">新增说话人</div>
